...
class Config(ParentConfig):
    name: str = "qwen38-27b-lora-64k"

    def __post_init__(self):
        self.model.max_context_length = 65536
        self.routing.default = False
        self.trainer.config["options"]["context_parallel_size"] = 2
        self.trainer.config["options"]["max_tokens_per_gpu"] = 32768
        self.inference.scaling.target_concurrency = 8
        self.inference.config["max_running_requests"] = 16
