...
HF_CHECKPOINT = "/assets/Qwen3-8B"
DEFINITION_ID = "qwen3_8b_deepspeed_full_2k"
...
def qwen3_8b_deepspeed_full_2k(instance_id: str) -> None:
    import json
...
ENGINE_FUNCTION = qwen3_8b_deepspeed_full_2k
