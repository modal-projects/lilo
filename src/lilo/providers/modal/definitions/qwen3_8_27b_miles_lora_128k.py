...
DEFINITION_ID = "qwen3_8_27b_miles_lora_128k"
...
def qwen3_8_27b_miles_lora_128k(instance_id: str) -> None:
...
ENGINE_FUNCTION = qwen3_8_27b_miles_lora_128k
