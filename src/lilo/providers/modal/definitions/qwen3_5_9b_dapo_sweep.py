...
DEFINITION_ID = "qwen3_5_9b_dapo_sweep"
PARAMETERIZATION = "lora"
CATALOG_VISIBLE = False
# Rewritten per run so inference pools cannot be reused across sweep points.
SWEEP_ISOLATION_ID = "template"
...
ROLLOUT_MAX_RUNNING_REQUESTS = 128
ROLLOUT_MAX_QUEUED_REQUESTS = 256
ROLLOUT_TARGET_CONCURRENCY = 128
# Bound retained publication versions per replica; older versions reload on demand.
ROLLOUT_MAX_LOADED_LORAS = 128
ROLLOUT_MIN_CONTAINERS = 8
ROLLOUT_MAX_CONTAINERS = 8
ROLLOUT_MAX_LORAS_PER_BATCH = 16
...
def qwen3_5_9b_dapo_sweep(instance_id: str) -> None:
...
ENGINE_FUNCTION = qwen3_5_9b_dapo_sweep
