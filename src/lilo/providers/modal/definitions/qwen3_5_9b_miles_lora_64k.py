...
DEFINITION_ID = "qwen3_5_9b_miles_lora_64k"
...
ROLLOUT_MAX_LORAS_PER_BATCH = 4
ROLLOUT_SCALEDOWN_WINDOW = 1200
...
def qwen3_5_9b_miles_lora_64k(instance_id: str) -> None:
...
def run_trainer(
    ...
    *,
    ...
    # Validate/resume assets, including interrupted downloads.
    ...
    run_engine_with_backend(
        ...
        sampler_persistence_concurrency=4,
        notify_reconciler=False,
    )


ENGINE_FUNCTION = qwen3_5_9b_miles_lora_64k
