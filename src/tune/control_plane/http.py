...
from tune.engine.api import JSON_OPERATIONS, OperationKind, submit_json_operation
...
from tune.providers.contracts import Parameterization
...
def create_control_plane_app(
    ...
    *,
    ...
    checkpoint_volume: str = "tune-checkpoints",
) -> FastAPI:
    definitions = tuple(
        definition
