...
SESSION_KV_NAME = "tune-sessions"
MODEL_KV_NAME = "tune-models"
ENGINE_KV_NAME = "tune-engines"
SAMPLING_SESSION_KV_NAME = "tune-sampling-sessions"
EXPORT_KV_NAME = "tune-exports"
ARTIFACT_KV_NAME = "tune-artifacts"
FFT_POOL_KV_NAME = "tune-fft-pools"
...
def app_store_name(name: str, app_id: str) -> str:
    return f"{app_id}-{name.removeprefix('tune-')}"
