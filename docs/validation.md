...
30-step Tune and Miles FFT runs on DAPO Math with an 8k generation cap:

![Qwen3.5-4B DAPO Math: Tune versus Miles](assets/validation/qwen3-5-4b-dapo.png)

### Qwen3.5-9B: Tune and Miles

This is a 29-step Qwen3.5-9B DAPO Math comparison with async RL and a 20k
generation cap.

![Qwen3.5-9B DAPO Math: Tune versus Miles](assets/validation/qwen3-5-9b-dapo-vs-miles.png)

We see comparabale reward and step time between Tune and Miles.

### Qwen3.6-27B

Tune and Miles FFT runs on DAPO Math with an 8k generation cap. Tune completed
30 steps; the ongoing Miles run is shown through its latest completed step:

![Qwen3.6-27B DAPO Math: Tune versus Miles](assets/validation/qwen3-6-27b-dapo.png)

### Qwen3.6-35B-A3B

30-step Tune FFT on DAPO math with 8k generation cap:
